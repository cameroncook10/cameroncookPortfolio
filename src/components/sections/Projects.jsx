...
export const Projects = () => {
    return (
    <section id="projects" className="min-h-screen flex items-center justify py-20"
    >
    <RevealOnScroll>
        ...
        <div className="gird grid-cols-1 md:grid-cols-2 gap-6">
            ...
            ">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                    {["Linux", "VirtualBox", "Python", "Wireshark", "Penetration Testing", "Incident Response" ].map((tech, key) => (
                        <span
                        key={key}
                       className="bg-blue-500/40 text-blue-300 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20
                ...
                <div className="flex justify-between items-center">
                    <a href="https://github.com/cameroncook10/Cybersecurity-Homelab" 
                    className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                    > 
                    {""}
                    Github Repository 🢂{""}
            ...
            ">
                ...
                <p className="text-gray-300 mb-4"> 
                    My perosnal website build with React and Tailwind CSS.
                ...
                <div className="flex justify-between items-center">
                    <a href="https://github.com/cameroncook10/Personal-Portfolio-Website" 
                    className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                    > 
                    {""}
                    Github Repository 🢂{""}
